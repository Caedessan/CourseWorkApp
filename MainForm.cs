...
namespace CourseWorkApp
{
    public partial class MainForm : Form
    {
        ...
        public void ToggleControl(int toggle)
        {
            if(toggle == 0)
            {
                ...
                pasportBox.Enabled = false;
                birthdayPicker.Enabled = false;
                birthplaceBox.Enabled = false;
            ...
            else
            {
                ...
                pasportBox.Enabled = true;
                birthdayPicker.Enabled = true;
                birthplaceBox.Enabled = true;
        ...
        {
            new UserControl(logic).ShowDialog();
        }
    }
}
